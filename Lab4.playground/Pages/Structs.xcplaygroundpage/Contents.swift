...
/*:
 Change `somePlace`'s latitude to 51.514004, and the longitude to  51.514004, then print the updated values.
 */
...
favoriteBook.title = "The Walking Dead"
favoriteBook.author = "Robert Kirkman"
favoriteBook.pages = 116
